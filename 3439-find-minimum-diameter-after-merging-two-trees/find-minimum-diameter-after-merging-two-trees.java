class Solution {
    ...
    public int findDiameter(Map<Integer, List<Integer>> adjList) {
        List<Integer> farthestNode = findFarthest(adjList, 0);

        farthestNode = findFarthest(adjList, farthestNode.get(0));
        return farthestNode.get(1);
    }

    public List<Integer> findFarthest(Map<Integer, List<Integer>> adjList, int sourceNode) {
